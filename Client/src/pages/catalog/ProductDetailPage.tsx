...
export default function ProductDetailPage(){
    ...
    useEffect(() => {
        fetch(`http://localhost:5216/api/products/${id}`)
    ...
    return (
       <Grid container spacing={6}>
            <Grid size={{xl:3, lg:4, md:7, sm:6, xs:12}}>
                <img src={`http://localhost:5216/images/${product.imageUrl}`}  style={{ width: '100%'}} />
            </Grid>
            <Grid size={{xl:9, lg:8, md:5, sm:6, xs:12}}>
